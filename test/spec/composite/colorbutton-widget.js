...
describe("photonui.ColorButton (widget)", function() {

    beforeEach(function() {
        this.c = new DummyContainer();
        this.w = new photonui.ColorButton();
    });
    ...
    it("has the 'photonui-colorbutton' class on its outer HTML", function() {
        expect(this.w.html.className).toContain("photonui-colorbutton");
    });
