...
describe("photonui.FontSelect (widget)", function() {

    beforeEach(function() {
        this.c = new DummyContainer();
        this.w = new photonui.FontSelect();
    });
    ...
    it("has the 'photonui-fontselect' class on its outer HTML", function() {
        expect(this.w.html.className).toContain("photonui-fontselect");
    });
