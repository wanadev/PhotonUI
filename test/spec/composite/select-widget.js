...
describe("photonui.Select (widget)", function() {

    beforeEach(function() {
        this.c = new DummyContainer();
        this.w = new photonui.Select();
    });
    ...
    it("has the 'photonui-select' class on its outer HTML", function() {
        expect(this.w.html.className).toContain("photonui-select");
    });
