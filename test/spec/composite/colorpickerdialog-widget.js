...
describe("photonui.ColorPickerDialog (widget)", function() {

    beforeEach(function() {
        this.c = new DummyContainer();
        this.w = new photonui.ColorPickerDialog();
    });
    ...
    it("has the 'photonui-colorpickerdialog' class on its outer HTML", function() {
        expect(this.w.html.className).toContain("photonui-colorpickerdialog");
    });
