...
describe("photonui.PopupMenu (widget)", function() {

    beforeEach(function() {
        this.c = new DummyContainer();
        this.w = new photonui.PopupMenu();
    });
    ...
    it("has the 'photonui-popupmenu' class on its outer HTML", function() {
        expect(this.w.html.className).toContain("photonui-popupmenu");
    });
