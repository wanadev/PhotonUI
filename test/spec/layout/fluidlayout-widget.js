...
describe("photonui.FluidLayout (widget)", function() {

    beforeEach(function() {
        this.c = new DummyContainer();
        this.w = new photonui.FluidLayout();
    });
    ...
    it("has the 'photonui-fluidlayout' class on its outer HTML", function() {
        expect(this.w.html.className).toContain("photonui-fluidlayout");
    });
