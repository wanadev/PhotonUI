...
describe("photonui.TabLayout (layout)", function() {

    beforeEach(function() {
        this.l1 = new photonui.TabLayout();
        this.l2 = new photonui.TabLayout();
        this.w1 = new photonui.TabItem();
        this.w2 = new photonui.TabItem();
        this.w3 = new photonui.TabItem();
    });
