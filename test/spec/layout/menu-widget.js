...
describe("photonui.Menu (widget)", function() {

    beforeEach(function() {
        this.c = new DummyContainer();
        this.w = new photonui.Menu();
    });
    ...
    it("has the 'photonui-menu' class on its outer HTML", function() {
        expect(this.w.html.className).toContain("photonui-menu");
    });
