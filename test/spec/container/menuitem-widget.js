...
describe("photonui.MenuItem (widget)", function() {

    beforeEach(function() {
        this.c = new DummyContainer();
        this.w = new photonui.MenuItem();
    });
    ...
    it("has the 'photonui-menuitem' class on its outer HTML", function() {
        expect(this.w.html.className).toContain("photonui-menuitem");
    });
