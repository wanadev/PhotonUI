...
describe("photonui.SubMenuItem (widget)", function() {

    beforeEach(function() {
        this.c = new DummyContainer();
        this.w = new photonui.SubMenuItem();
    });
    ...
    it("has the 'photonui-submenuitem' class on its outer HTML", function() {
        expect(this.w.html.className).toContain("photonui-submenuitem");
    });
