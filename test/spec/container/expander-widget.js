...
describe("photonui.Expander (widget)", function () {

    beforeEach(function () {
        this.c = new DummyContainer();
        this.w = new photonui.Expander();
    });
    ...
    it("has the 'photonui-expander' class on its outer HTML", function () {
        expect(this.w.html.className).toContain("photonui-expander");
    });
