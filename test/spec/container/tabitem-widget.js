...
describe("photonui.TabItem (widget)", function() {

    beforeEach(function() {
        this.c = new DummyContainer();
        this.w = new photonui.TabItem();
    });
    ...
    it("has the 'photonui-tabitem' class on its outer HTML", function() {
        expect(this.w.html.className).toContain("photonui-tabitem");
    });
