...
describe("photonui.PopupWindow (widget)", function() {

    beforeEach(function() {
        this.c = new DummyContainer();
        this.w = new photonui.PopupWindow();
    });
    ...
    it("has the 'photonui-popupwindow' class on its outer HTML", function() {
        expect(this.w.html.className).toContain("photonui-popupwindow");
    });
