...
describe("photonui.Dialog (widget)", function() {

    beforeEach(function() {
        this.c = new DummyContainer();
        this.w = new photonui.Dialog();
    });
    ...
    it("has the 'photonui-dialog' class on its outer HTML", function() {
        expect(this.w.html.className).toContain("photonui-dialog");
    });
