...
describe("photonui.Viewport (widget)", function() {

    beforeEach(function() {
        this.c = new DummyContainer();
        this.w = new photonui.Viewport();
    });
    ...
    it("has the 'photonui-viewport' class on its outer HTML", function() {
        expect(this.w.html.className).toContain("photonui-viewport");
    });
