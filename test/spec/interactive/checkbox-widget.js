...
describe("photonui.CheckBox (widget)", function() {

    beforeEach(function() {
        this.c = new DummyContainer();
        this.w = new photonui.CheckBox();
    });
    ...
    it("has the 'photonui-checkbox' class on its outer HTML", function() {
        expect(this.w.html.className).toContain("photonui-checkbox");
    });
