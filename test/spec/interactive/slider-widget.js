...
describe("photonui.Slider (widget)", function() {

    beforeEach(function() {
        this.c = new DummyContainer();
        this.w = new photonui.Slider();
    });
    ...
    it("has the 'photonui-slider' class on its outer HTML", function() {
        expect(this.w.html.className).toContain("photonui-slider");
    });
