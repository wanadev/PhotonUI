...
describe("photonui.ToggleButton (widget)", function() {

    beforeEach(function() {
        this.c = new DummyContainer();
        this.w = new photonui.ToggleButton();
    });
    ...
    it("has the 'photonui-togglebutton' class on its outer HTML", function() {
        expect(this.w.html.className).toContain("photonui-togglebutton");
    });
