...
describe("photonui.IconButton (widget)", function () {

    beforeEach(function () {
        this.c = new DummyContainer();
        this.w = new photonui.IconButton();
    });
    ...
    it("has the 'photonui-iconbutton' class on its outer HTML", function () {
        expect(this.w.html.className).toContain("photonui-iconbutton");
    });
