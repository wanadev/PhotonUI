...
describe("photonui.Button (widget)", function() {

    beforeEach(function() {
        this.c = new DummyContainer();
        this.w = new photonui.Button();
    });
    ...
    it("has the 'photonui-button' class on its outer HTML", function() {
        expect(this.w.html.className).toContain("photonui-button");
    });
