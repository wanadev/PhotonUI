...
describe("photonui.ColorPalette (widget)", function() {

    beforeEach(function() {
        this.c = new DummyContainer();
        this.w = new photonui.ColorPalette();
    });
    ...
    it("has the 'photonui-colorpalette' class on its outer HTML", function() {
        expect(this.w.html.className).toContain("photonui-colorpalette");
    });
