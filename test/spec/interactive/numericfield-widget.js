...
describe("photonui.NumericField (widget)", function() {

    beforeEach(function() {
        this.c = new DummyContainer();
        this.w = new photonui.NumericField();
    });
    ...
    it("has the 'photonui-numericfield' class on its outer HTML", function() {
        expect(this.w.html.className).toContain("photonui-numericfield");
    });
