...
describe("photonui.TextField (widget)", function() {

    beforeEach(function() {
        this.c = new DummyContainer();
        this.w = new photonui.TextField();
    });
    ...
    it("has the 'photonui-textfield' class on its outer HTML", function() {
        expect(this.w.html.className).toContain("photonui-textfield");
    });
