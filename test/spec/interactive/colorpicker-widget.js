...
describe("photonui.ColorPicker (widget)", function() {

    beforeEach(function() {
        this.c = new DummyContainer();
        this.w = new photonui.ColorPicker();
    });
    ...
    it("has the 'photonui-colorpicker' class on its outer HTML", function() {
        expect(this.w.html.className).toContain("photonui-colorpicker");
    });
