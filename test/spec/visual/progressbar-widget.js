...
describe("photonui.ProgressBar (widget)", function() {

    beforeEach(function() {
        this.c = new DummyContainer();
        this.w = new photonui.ProgressBar();
    });
    ...
    it("has the 'photonui-progressbar' class on its outer HTML", function() {
        expect(this.w.html.className).toContain("photonui-progressbar");
    });
