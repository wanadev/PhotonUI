...
describe("photonui.Canvas (widget)", function() {

    beforeEach(function() {
        this.c = new DummyContainer();
        this.w = new photonui.Canvas();
    });
    ...
    it("has the 'photonui-canvas' class on its outer HTML", function() {
        expect(this.w.html.className).toContain("photonui-canvas");
    });
