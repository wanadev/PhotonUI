...
describe("photonui.Text (widget)", function() {

    beforeEach(function() {
        this.c = new DummyContainer();
        this.w = new photonui.Text();
    });
    ...
    it("has the 'photonui-text' class on its outer HTML", function() {
        expect(this.w.html.className).toContain("photonui-text");
    });
