...
describe("photonui.Label (widget)", function() {

    beforeEach(function() {
        this.c = new DummyContainer();
        this.w = new photonui.Label();
    });
    ...
    it("has the 'photonui-label' class on its outer HTML", function() {
        expect(this.w.html.className).toContain("photonui-label");
    });
