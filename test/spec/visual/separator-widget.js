...
describe("photonui.Separator (widget)", function() {

    beforeEach(function() {
        this.c = new DummyContainer();
        this.w = new photonui.Separator();
    });
    ...
    it("has the 'photonui-separator' class on its outer HTML", function() {
        expect(this.w.html.className).toContain("photonui-separator");
    });
