...
describe("photonui.SpriteIcon (widget)", function() {

    beforeEach(function() {
        this.c = new DummyContainer();
        this.w = new photonui.SpriteIcon();
    });
    ...
    it("has the 'photonui-spriteicon' class on its outer HTML", function() {
        expect(this.w.html.className).toContain("photonui-spriteicon");
    });
