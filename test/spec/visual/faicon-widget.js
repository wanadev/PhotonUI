...
describe("photonui.FAIcon (widget)", function() {

    beforeEach(function() {
        this.c = new DummyContainer();
        this.w = new photonui.FAIcon();
    });
    ...
    it("has the 'photonui-faicon' class on its outer HTML", function() {
        expect(this.w.html.className).toContain("photonui-faicon");
    });
